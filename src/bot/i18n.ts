...
const MESSAGES: Record<Locale, TranslationCatalog> = {
  en: {
    ...
    helpLines: () => [
      ...
      "/work - Show active, pending, paused, and blocked topic contexts",
      "/queue - Keep the active context and queue the pending request",
      "/switch - Pause the active context and start the pending request",
      "/close - Close the active context and start the pending request",
      "/pause - Pause the active context",
      "/done - Mark the active context done",
      "/drop <id> - Cancel a queued or paused context",
