...
export const DEFAULT_TELEGRAM_COMMANDS = [
  ...
  { command: "work", description: "Show topic context state" },
  { command: "queue", description: "Queue a pending topic switch" },
  { command: "switch", description: "Pause current topic and switch" },
  { command: "close", description: "Close current topic and switch" },
  { command: "pause", description: "Pause current topic" },
  { command: "done", description: "Mark current topic done" },
  { command: "drop", description: "Cancel a queued topic" },
